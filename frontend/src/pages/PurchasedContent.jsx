...
const PurchasedContent = () => {
  ...
  const applyFiltersAndSearch = () => {
    ...
    if (activeFilters.dateRange !== 'all') {
      ...
      filtered = filtered.filter(
        item => new Date(item.purchaseDate || item.createdAt) >= cutoffDate
      );
    }
      ...
      switch (sortBy) {
        ...
        case 'creator':
          return (
            ...
            a.creator?.username ||
            ''
          ).localeCompare(b.creator?.displayName || b.creator?.username || '');
        case 'price':
                ...
                >
                  <div className='purchased-content-thumbnail'>
                    <img
                      src={
                        item.thumbnail ||
                        '/placeholders/content-placeholder.jpg'
                      }
                      alt={item.title || 'Content'}
                      onError={e => {
                        e.target.src = '/placeholders/content-placeholder.jpg';
                      }}
                    />
