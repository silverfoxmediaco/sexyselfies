...
const CreatorVerifyID = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (!userEmail) {
        setErrors({
          submit: 'User email not found. Please log out and log back in.',
        });
        setLoading(false);
        return;
      }
      ...
      if (response && response.success) {
        ...
        setErrors({
          submit: response?.error || 'Failed to upload verification documents',
        });
      }
    } catch (error) {
      ...
      <div className='verify-id-page'>
        ...
        <div className='verify-container success-container'>
            ...
            <div className='timeline'>
              ...
              <div className='timeline-item'>
                ...
                <div className='timeline-content'>
                  ...
                  <p>
                    Our team will verify your identity (usually within 5-10
                    minutes)
                  </p>
                </div>
              </div>
              ...
              <div className='timeline-item'>
                ...
                <div className='timeline-content'>
                  ...
                  <p>
                    Access your creator dashboard and start uploading content
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className='info-box'>
            <p>
              📧 We'll send updates to the email address you registered with
            </p>
            <p>
              ⏱️ Most verifications are completed within 10 minutes during
              business hours
            </p>
      ...
      <div className='verify-container'>
        <div className='verify-header'>
          ...
          <p className='subtitle'>
            For everyone's safety, we need to verify you're a real person over
            18
          </p>
        </div>
        ...
        <div className='verify-form'>
          ...
          <div className='upload-grid'>
            ...
            <div className='upload-card'>
              ...
              {errors.front && (
                <span className='error-text'>{errors.front}</span>
              )}
            </div>
            ...
            {(idType === 'drivers_license' || idType === 'state_id') && (
              <div className='upload-card'>
                ...
                {errors.back && (
                  <span className='error-text'>{errors.back}</span>
                )}
              </div>
            )}
            ...
            <div className='upload-card'>
              ...
              {errors.selfie && (
                <span className='error-text'>{errors.selfie}</span>
              )}
            </div>
          </div>
          ...
          <div className='warning-box'>
            ...
            <span className='warning-text'>
              Your ID information is encrypted and securely stored. We only use
              it to verify your age and identity, and never share it with third
              parties.
            </span>
          </div>
