...
const AdminManagement = () => {
  ...
  const getRoleBadgeClass = role => {
    switch (role) {
      case 'superAdmin':
        return 'admin-management-role-super';
      case 'moderator':
        return 'admin-management-role-moderator';
      case 'verificationStaff':
        return 'admin-management-role-verification';
      default:
        return '';
    }
  };
  ...
  return (
    <>
      ...
      <div className='admin-management-container'>
            ...
            <div key={admin._id} className='admin-management-admin-card'>
              <div className='admin-management-admin-card-header'>
                ...
                <button
                  ...
                  onClick={() =>
                    setExpandedCard(
                      expandedCard === admin._id ? null : admin._id
                    )
                  }
                  aria-label={
                    expandedCard === admin._id ? 'Collapse' : 'Expand'
                  }
                >
                  <svg
                    width='20'
              ...
              <div className='admin-management-admin-role'>
                <span
                  className={`admin-management-role-badge ${getRoleBadgeClass(admin.role)}`}
                >
                  {admin.role.replace(/([A-Z])/g, ' $1').trim()}
                </span>
                <span
                  className={`admin-management-status-badge ${admin.isActive ? 'active' : 'inactive'}`}
                >
              ...
              <div
                className={`admin-management-admin-details ${expandedCard === admin._id ? 'expanded' : ''}`}
              >
                <div className='admin-management-admin-stats'>
                  ...
                  <div className='admin-management-stat'>
                    <span className='admin-management-stat-label'>
                      Last Login
                    </span>
                    <span className='admin-management-stat-value'>
                      {admin.lastLogin
                ...
                <div className='admin-management-permissions-section'>
                  ...
                  <div className='admin-management-permissions-list'>
                    {getPermissionsList(admin.role).map((permission, index) => (
                      <span
                        key={index}
                        className='admin-management-permission-tag'
                      >
                        {permission}
                      </span>
                    ))}
        ...
        {showCreateModal && (
          <div
            className='admin-management-modal-overlay'
            onClick={() => setShowCreateModal(false)}
          >
            <div
              className='admin-management-modal-content'
            ...
            >
              ...
              <div className='admin-management-form-group'>
                ...
                />
                {formErrors.name && (
                  <span className='admin-management-error-message'>
                    {formErrors.name}
                  </span>
                )}
              </div>
              ...
              <div className='admin-management-role-description'>
                {formData.role === 'moderator' && (
                  <p>
                    Can review content, manage reports, suspend users, and
                    remove content.
                  </p>
                )}
                ...
                {formData.role === 'superAdmin' && (
                  <p>
                    Full system access including managing other admins and all
                    moderation tools.
                  </p>
                )}
              </div>
        ...
        {showEditModal && selectedAdmin && (
          ...
          >
            ...
            >
              ...
              <p className='admin-management-edit-info'>
                Editing: {selectedAdmin.name} ({selectedAdmin.email})
              </p>
              ...
              <div className='admin-management-status-description'>
                {editData.isActive ? (
                  <p className='admin-management-status-active'>
                    Admin will be able to login and perform actions.
                  </p>
                ) : (
                  <p className='admin-management-status-inactive'>
                    Admin will be unable to login or perform any actions.
                  </p>
                )}
              </div>
