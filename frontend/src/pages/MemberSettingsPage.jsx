    ...
    try {
      ...
      setSettings(prev => ({
        ...
        profileVisibility:
          ...
          preferences.profileVisibility === 'hidden'
            ? 'hidden'
            : 'visible',
        allowMessages:
          preferences.allowMessages === 'none' ? 'none' : 'creators',
        showOnlineStatus:
          preferences.showOnlineStatus !== undefined
            ? preferences.showOnlineStatus
            : userData.showOnlineStatus !== undefined
              ? userData.showOnlineStatus
              : prev.showOnlineStatus,
        contentFiltering:
          preferences.contentFiltering !== undefined
            ? preferences.contentFiltering
            : userData.contentFiltering !== undefined
              ? userData.contentFiltering
        ...
        <div className='member-settings-group'>
          ...
          <div className='member-setting-item'>
            ...
            <input
              ...
              placeholder={
                loadingSettings ? 'Loading...' : 'Enter your email address'
              }
          ...
          <div className='member-setting-item'>
            ...
            <input
              ...
              className='member-setting-input'
              placeholder={
                loadingSettings ? 'Loading...' : 'Enter your username'
              }
              disabled={loadingSettings}
            />
          </div>
        ...
        <div className='member-settings-group'>
          ...
          <div className='member-setting-item'>
            ...
            <input
              ...
              onChange={e =>
                updateSetting(null, 'currentPassword', e.target.value)
              }
              className='member-setting-input'
          ...
          <div className='member-setting-item'>
            ...
            <input
              ...
              onChange={e =>
                updateSetting(null, 'confirmPassword', e.target.value)
              }
              className='member-setting-input'
        ...
        <div className='member-settings-group'>
          ...
          <div className='member-setting-item'>
            ...
            <input
              ...
              className='member-setting-input'
              placeholder={
                loadingSettings ? 'Loading...' : 'How others see your name'
              }
              disabled={loadingSettings}
            />
          </div>
        ...
        <div className='member-settings-group'>
          ...
          <div className='member-setting-item'>
            ...
            <select
              ...
              onChange={e =>
                updateSetting(null, 'contentFiltering', e.target.value)
              }
        ...
        <div className='member-settings-group'>
          ...
          <div className='member-setting-item'>
            ...
            <select
              ...
              onChange={e =>
                updateSetting(null, 'allowMessages', e.target.value)
              }
              className='member-setting-select'
            >
            ...
            <div key={key} className='member-setting-item'>
              <div className='member-setting-toggle'>
                ...
                <button
                  ...
                  onClick={() =>
                    updateSetting('emailNotifications', key, !value)
                  }
                >
                  <div className='member-toggle-handle'></div>
                </button>
            ...
            <div key={key} className='member-setting-item'>
              <div className='member-setting-toggle'>
                ...
                <button
                  className={`member-toggle-switch ${value ? 'active' : ''}`}
                  onClick={() =>
                    updateSetting('pushNotifications', key, !value)
                  }
                >
                  <div className='member-toggle-handle'></div>
                </button>
      ...
      <div className='member-settings-mobile'>
        ...
        {unsavedChanges && (
          <div className='member-settings-mobile-save'>
            ...
            >
              {saveStatus === 'saving' && (
                <div className='member-settings-spinner' />
              )}
