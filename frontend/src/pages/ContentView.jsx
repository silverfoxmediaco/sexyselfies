...
const ContentView = () => {
    ...
    return (
      <div className='content-view-container'>
        ...
        <div className='content-view-error'>
          ...
          <p>
            {error || 'This content may have been removed or is not available.'}
          </p>
          <button
            onClick={() => navigate(-1)}
  ...
  return (
    <div className='content-view-container'>
      ...
      <div
        className={`content-view-main ${isDesktop ? 'content-view-desktop' : ''}`}
      >
        {/* Header */}
                  ...
                  {content.media.length > 1 && (
                    <div className='content-view-media-nav'>
                      ...
                      <button
                        onClick={nextMedia}
                        disabled={
                          currentMediaIndex === content.media.length - 1
                        }
          ...
          <div className='content-view-title-section'>
            ...
            <div className='content-view-meta'>
              ...
              <div className='content-view-type'>
                ...
                <span>
                  {content.media?.length || 1}{' '}
                  {content.media?.length === 1 ? 'item' : 'items'}
                </span>
              </div>
