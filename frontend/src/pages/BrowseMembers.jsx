...
const BrowseMembers = () => {
  ...
  const mockMembers = [
    {
      ...
      badges: ['big-spender', 'vip', 'loyal-fan'],
    ...
    },
    {
      ...
      preferences: {
        ...
        priceRange: [10, 100],
        contentType: ['videos', 'live', 'messages', 'photos']
      },
      activity: {
        lastPurchase: new Date(Date.now() - 3600000).toISOString(),
    ...
    // Add more mock members to ensure scrolling
    {
      id: '6',
    ...
    },
    {
      ...
      stats: {
        totalSpent: 2156.75,
        last30DaySpend: 456.75,
        averagePurchase: 35.50,
        contentPurchases: 61,
        tipsGiven: 28,
      ...
      preferences: {
        categories: ['Premium', 'Exclusive', 'Art'],
        priceRange: [10, 50],
        contentType: ['videos', 'photos', 'messages']
      },
      activity: {
    ...
    },
    {
      ...
      stats: {
        totalSpent: 78.50,
        last30DaySpend: 23.50,
        averagePurchase: 7.85,
        contentPurchases: 10,
        tipsGiven: 2,
    ...
    },
    {
      ...
      stats: {
        totalSpent: 567.89,
        last30DaySpend: 145.89,
        averagePurchase: 18.93,
        contentPurchases: 30,
        tipsGiven: 12,
        messagesExchanged: 67,
        favoriteContent: 'Tech Content',
        responseRate: 81
      },
      preferences: {
        priceRange: [5, 30],
    ...
    },
    {
      ...
      stats: {
        totalSpent: 1889.45,
        last30DaySpend: 334.45,
        averagePurchase: 41.97,
        contentPurchases: 45,
        tipsGiven: 22,
        messagesExchanged: 98,
        favoriteContent: 'Artistic Content',
        responseRate: 92
      },
      preferences: {
        categories: ['Art', 'Creative', 'Photography'],
        priceRange: [15, 75],
        contentType: ['photos', 'videos', 'messages']
      },
      activity: {
        lastPurchase: new Date(Date.now() - 432000000).toISOString(),
        purchaseFrequency: 'weekly',
  ...
  useEffect(() => {
    ...
    const isDevelopment = localStorage.getItem('token') === 'dev-token-12345';
    
    if (isDevelopment) {
      console.log('DEV MODE: Loading mock members data directly');
      setMembers(mockMembers);
      setFilteredMembers(mockMembers);
      calculateAnalytics(mockMembers);
      setLoading(false);
    } else {
      fetchMembers();
    }
