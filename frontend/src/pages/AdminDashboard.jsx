    ...
    try {
      ...
      try {
        const sessionResponse = await api.get(
          '/sessions/admin/analytics?days=1'
        );
          ...
          !loading && (
            <div className='dashboard-content'>
              ...
              <div className='stats-grid'>
                ...
                <div
                  className={`stat-card ${stats?.moderation?.pendingVerifications > 0 ? 'alert-card' : ''}`}
                >
                  <div className='stat-icon verifications'>
                    ...
                    {stats?.moderation?.pendingVerifications > 0 && (
                      <span className='alert-badge'>
                        {stats.moderation.pendingVerifications}
                      </span>
                    )}
                  </div>
                  <div className='stat-details'>
                ...
                <div className='stat-card'>
                  ...
                  <div className='stat-details'>
                    <h3>24h Revenue</h3>
                    <p className='stat-number'>
                      ${stats?.financials?.last24Hours?.total || 0}
                    </p>
                    <span className='stat-meta'>
                      {stats?.financials?.last24Hours?.count || 0} transactions
                    </span>
                  </div>
                </div>
                ...
                <div className='stat-card'>
                  ...
                  <div className='stat-details'>
                    ...
                    <span className='stat-meta'>
                      {sessionStats?.totalSessions || 0} total today
                    </span>
                  </div>
                </div>
                ...
                {sessionStats?.security?.totalSuspiciousActivities > 0 && (
                  <div className='stat-card alert-card'>
                    <div className='stat-icon security'>
                      ...
                      {sessionStats.security.totalSuspiciousActivities > 0 && (
                        <span className='alert-badge'>
                          {sessionStats.security.totalSuspiciousActivities}
                        </span>
                      )}
                    </div>
                    <div className='stat-details'>
              ...
              <div className='quick-actions'>
                ...
                <div className='action-buttons'>
                  <Link
                    ...
                    className='admin-dashboard-action-btn primary'
                  >
                    <svg viewBox='0 0 24 24' fill='currentColor'>
                  ...
                  <Link
                    to='/admin/reports'
                    className='admin-dashboard-action-btn warning'
                  >
                    <svg viewBox='0 0 24 24' fill='currentColor'>
                  ...
                  <Link
                    to='/admin/users'
                    className='admin-dashboard-action-btn info'
                  >
                    <svg viewBox='0 0 24 24' fill='currentColor'>
              ...
              {sessionStats && (
                <div className='session-analytics'>
                  ...
                  <div className='analytics-grid'>
                      ...
                      <div className='analytics-metrics'>
                        <div className='metric-item'>
                          ...
                          <span className='metric-value'>
                            {sessionStats.avgDurationMinutes?.toFixed(1) || 0}{' '}
                            min
                          </span>
                        </div>
                        <div className='metric-item'>
                        ...
                        <div className='metric-item'>
                          ...
                          <span className='metric-value'>
                            {sessionStats.totalActivities || 0}
                          </span>
                        </div>
                      </div>
                    </div>
                          ...
                          <div key={index} className='device-item'>
                            ...
                            <div className='device-bar'>
                              <div
                                ...
                                style={{
                                  width: `${(device.count / sessionStats.totalSessions) * 100}%`,
                                }}
                              ></div>
                    ...
                    <div className='analytics-card'>
                      ...
                      <div className='user-type-stats'>
                        {sessionStats.userTypeBreakdown?.map(
                          (userType, index) => (
                            <div key={index} className='user-type-item'>
                              <div className='user-type-header'>
                                ...
                                <span className='user-type-count'>
                                  {userType.count} sessions
                                </span>
                              </div>
                              <div className='user-type-details'>
                                <span>
                                  Avg: {userType.avgDuration?.toFixed(1) || 0}
                                  min
                                </span>
                                {userType.totalRevenue && (
                                  <span>
                                    Revenue: $
                                    {userType.totalRevenue?.toFixed(2)}
                                  </span>
                                )}
                              </div>
                            </div>
                  ...
                  {/* Peak Hours */}
                  {sessionStats.peakHours &&
                    sessionStats.peakHours.length > 0 && (
                          ...
                          {sessionStats.peakHours
                            ...
                            .map((hour, index) => (
                              <div key={index} className='peak-hour-item'>
                                ...
                                <span className='hour-sessions'>
                                  {hour.sessions} sessions
                                </span>
                                <span className='hour-duration'>
                                  Avg: {hour.avgDuration?.toFixed(1) || 0}min
                                </span>
                              </div>
                            ))}
                        </div>
