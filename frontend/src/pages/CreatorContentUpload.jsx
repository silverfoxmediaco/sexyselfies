    ...
    >
      ...
      {uploads.length === 0 ? (
        <div className='creator-content-upload-drop-zone-content'>
          ...
          <p className='creator-content-upload-file-limit'>
            Max 100MB per file
          </p>
        </div>
      ) : (
          ...
          {uploads.map(upload => (
            ...
            >
                ...
                {upload.status === 'uploading' && (
                  <div className='creator-content-upload-progress-overlay'>
                    <div className='creator-content-upload-progress-circle'>
                      <Loader
                        className='creator-content-upload-spinning'
                        size={24}
                      />
              ...
              <div className='creator-content-upload-file-info'>
                <p className='creator-content-upload-file-name'>
                  {upload.name}
                </p>
                    ...
                    {upload.price > 0 && (
                      <div className='creator-content-upload-price-input'>
                        ...
                        <input
                          ...
                          value={upload.price}
                          onChange={e =>
                            updateFilePrice(upload.id, e.target.value)
                          }
                          onClick={e => e.stopPropagation()}
                        />
                      </div>
    ...
    >
      ...
      <div className='creator-content-upload-form-group'>
        ...
        <input
          ...
          onChange={e =>
            setContentDetails(prev => ({ ...prev, title: e.target.value }))
          }
        />
      </div>
      ...
      <div className='creator-content-upload-form-group'>
        ...
        <div className='creator-content-upload-category-grid'>
          {[
            ...
            <motion.button
              ...
              onClick={() =>
                setContentDetails(prev => ({ ...prev, category: category.id }))
              }
        ...
        {errors.category && (
          <span className='creator-content-upload-error-text'>
            {errors.category}
          </span>
        )}
      </div>
          ...
          <div className='creator-content-upload-popular-tags'>
            {[
              ...
              <button
                ...
                disabled={
                  !contentDetails.tags.includes(tag) &&
                  contentDetails.tags.length >= 5
                }
              >
                {tag}
              </button>
  ...
  >
      ...
      <div className='creator-content-upload-pricing-list'>
        {uploads.map(upload => (
          <div key={upload.id} className='creator-content-upload-pricing-item'>
            <span className='creator-content-upload-file-name'>
              {upload.name}
            </span>
            <span className='creator-content-upload-price'>
              ${upload.price}
            </span>
          </div>
        ))}
        <div className='creator-content-upload-pricing-total'>
          ...
          <span className='creator-content-upload-total'>
            $
            {(
              uploads.reduce((acc, u) => acc + u.price, 0) / uploads.length
            ).toFixed(2)}
          </span>
        </div>
      </div>
    ...
    <div className='creator-content-upload-visibility-options'>
      ...
      <div className='creator-content-upload-visibility-grid'>
        ...
        <label className='creator-content-upload-visibility-option'>
          ...
          <div className='creator-content-upload-option-content'>
            <Calendar size={20} />
            <span className='creator-content-upload-option-title'>
              Schedule
            </span>
            <span className='creator-content-upload-option-desc'>
    ...
    <div className='creator-content-upload-earnings-preview'>
      ...
      <div className='creator-content-upload-earnings-content'>
        ...
        <div className='creator-content-upload-earnings-stat'>
          <span className='creator-content-upload-stat-label'>
            Potential (100 views):
          </span>
...
const CreatorContentUpload = () => {
  ...
  const addCustomTag = e => {
    if (e.key === 'Enter' && e.target.value.trim()) {
      ...
      if (
        !contentDetails.tags.includes(newTag) &&
        contentDetails.tags.length < 5
      ) {
        setContentDetails(prev => ({
          ...prev,
    ...
    <div className='creator-content-upload-page'>
      ...
      <div className='creator-content-upload-container'>
        ...
        <div className='creator-content-upload-steps'>
          <div
            className={`creator-content-upload-step-indicator ${currentStep >= 1 ? 'creator-content-upload-active' : ''} ${currentStep === 1 ? 'creator-content-upload-current' : ''}`}
          >
          ...
          <div
            className={`creator-content-upload-step-indicator ${currentStep >= 2 ? 'creator-content-upload-active' : ''} ${currentStep === 2 ? 'creator-content-upload-current' : ''}`}
          >
            <div className='creator-content-upload-step-number'>
          ...
          <div
            className={`creator-content-upload-step-indicator ${currentStep >= 3 ? 'creator-content-upload-active' : ''} ${currentStep === 3 ? 'creator-content-upload-current' : ''}`}
          >
            <div className='creator-content-upload-step-number'>
