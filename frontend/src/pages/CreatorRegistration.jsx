    ...
    switch (stepNumber) {
      ...
      case 3:
        ...
        if (!formData.agreeToContentPolicy) {
          newErrors.agreeToContentPolicy =
            'You must agree to the content policy';
        }
        if (!formData.over18Confirmation) {
          newErrors.over18Confirmation = 'You must confirm you are over 18';
        }
        if (!formData.taxInfoConsent) {
          newErrors.taxInfoConsent =
            'You must consent to provide tax information';
        }
        break;
    }
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (response && response.success && response.token) {
        ...
        alert(
          'Registration successful! You will now be redirected to complete ID verification.'
        );
        ...
        setErrors({
          submit: response?.error || response?.message || 'Registration failed',
        });
      }
    } catch (error) {
      ...
      if (error.response && error.response.data) {
        ...
        if (backendError.errors && Array.isArray(backendError.errors)) {
          ...
          setErrors({
            submit: `Server error (${error.response.status}): ${JSON.stringify(backendError)}`,
          });
        }
      ...
      case 1:
        return (
          <div className='creator-registration-step'>
            ...
            <p className='creator-registration-step-subtitle'>
            ...
            <div className='creator-registration-form-group'>
              ...
              <input
                ...
                className={
                  errors.email ? 'creator-registration-input-error' : ''
                }
              />
              {errors.email && (
                <span className='creator-registration-error-message'>
                  {errors.email}
                </span>
              )}
            </div>
            ...
            <div className='creator-registration-form-group'>
              ...
              <div className='creator-registration-password-input-wrapper'>
                <input
                  ...
                  className={
                    errors.password ? 'creator-registration-input-error' : ''
                  }
                />
                <button
                  type='button'
                ...
                <input
                  ...
                  className={
                    errors.confirmPassword
                      ? 'creator-registration-input-error'
                      : ''
                  }
                />
                <button
          ...
          <div className='creator-registration-step'>
            ...
            <div className='creator-registration-form-group'>
              ...
              <input
                ...
                className={
                  errors.displayName ? 'creator-registration-input-error' : ''
                }
              />
              {errors.displayName && (
                <span className='creator-registration-error-message'>
            ...
            <div className='creator-registration-form-group'>
              ...
              <input
                ...
                className={
                  errors.username ? 'creator-registration-input-error' : ''
                }
              />
              {errors.username && (
                <span className='creator-registration-error-message'>
            ...
            <div className='creator-registration-form-group'>
              ...
              <input
                ...
                className={
                  errors.dateOfBirth ? 'creator-registration-input-error' : ''
                }
              />
              {errors.dateOfBirth && (
                <span className='creator-registration-error-message'>
            ...
            <div className='creator-registration-form-group'>
              ...
              <select
                ...
                onChange={handleInputChange}
                className={
                  errors.country ? 'creator-registration-input-error' : ''
                }
              >
          ...
          <div className='creator-registration-step'>
            ...
            <div className='creator-registration-agreements'>
              ...
              <label className='creator-registration-checkbox-label'>
                ...
                <span>
                  I agree to the{' '}
                  <Link to='/content-policy'>Content Policy</Link> and community
                  guidelines
                </span>
              </label>
              {errors.agreeToContentPolicy && (
                <span className='creator-registration-error-message'>
                  {errors.agreeToContentPolicy}
                </span>
              )}
          ...
          <div className='creator-registration-container'>
            <div className='creator-registration-content'>
              ...
              <form
                ...
                className='creator-registration-form'
              >
                {renderStep()}
              ...
              <div className='creator-registration-footer'>
                <p>
                  ...
                  <Link to='/creator/login'>Sign In</Link>
                </p>
              </div>
            </div>
          </div>
