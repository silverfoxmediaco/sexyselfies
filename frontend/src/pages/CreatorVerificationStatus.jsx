...
const CreatorVerificationStatus = () => {
  ...
  const handleSubmitVerification = async () => {
    ...
    try {
      ...
      setSuccess(
        'Verification documents uploaded successfully! Your account will be reviewed within 24-48 hours.'
      );
      ...
      setError(
        error.response?.data?.error || 'Failed to upload verification documents'
      );
    } finally {
      setUploading(false);
    }
  ...
  return (
    <div className='CreatorVerificationStatus-container'>
      ...
      <div
        className={`verification-content ${isMobile ? 'mobile' : 'desktop'}`}
      >
        {/* Header */}
        ...
        {(!verificationStatus?.status ||
          ...
          <div className='verification-upload-section'>
            ...
            <p className='upload-instructions'>
              Upload clear, high-quality photos of your government-issued ID and
