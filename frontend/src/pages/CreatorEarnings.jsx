        ...
        <div className="breakdown-cards">
          <div className="breakdown-card">
            ...
            <div className="breakdown-stats">
              <span className="percentage">{earningsData.breakdown.photos.percentage}% of total</span>
              <span className="count">{earningsData.breakdown.photos.count} sales</span>
            </div>
          </div>
          ...
          <div className="breakdown-card">
            ...
            <div className="breakdown-stats">
              <span className="percentage">{earningsData.breakdown.videos.percentage}% of total</span>
              <span className="count">{earningsData.breakdown.videos.count} sales</span>
            </div>
          </div>
          ...
          <div className="breakdown-card">
            ...
            <div className="breakdown-stats">
              <span className="percentage">{earningsData.breakdown.messages.percentage}% of total</span>
              <span className="count">{earningsData.breakdown.messages.count} sales</span>
            </div>
          </div>
          ...
          <div className="breakdown-card">
            ...
            <div className="breakdown-stats">
              <span className="percentage">{earningsData.breakdown.tips.percentage}% of total</span>
              <span className="count">{earningsData.breakdown.tips.count} tips</span>
            </div>
          </div>
        </div>
      </div>
              ...
              {earningsData.recentTransactions.map((transaction) => (
                <div key={transaction.id} className="transaction-item">
                  <div className="transaction-icon">
                    ...
                    {transaction.type === 'message' && <MessageCircle size={16} />}
                    {transaction.type === 'tip' && <Gift size={16} />}
                  </div>
                  <div className="transaction-info">
                    <span className="transaction-user">{transaction.user}</span>
                    <span className="transaction-type">
                      {transaction.type === 'tip' ? 'sent a tip' : `purchased ${transaction.type}`}
                    </span>
        ...
        <div className="goal-card">
          <div className="goal-header">
            <div className="goal-info">
              ...
              <span className="goal-subtitle">{earningsData.goals.daysLeft} days remaining</span>
            </div>
            <div className="goal-target">
              {formatCurrency(earningsData.goals.currentProgress)} / {formatCurrency(earningsData.goals.monthlyTarget)}
            </div>
          </div>
          <div className="goal-progress">
            <div className="progress-bar">
              <div 
                ...
                style={{ width: `${(earningsData.goals.currentProgress / earningsData.goals.monthlyTarget) * 100}%` }}
              ></div>
            </div>
            <div className="progress-stats">
              <span className="progress-percentage">
                {Math.round((earningsData.goals.currentProgress / earningsData.goals.monthlyTarget) * 100)}% complete
              </span>
