...
const MemberRegistration = () => {
  ...
  const memberBenefits = [
    {
      ...
      description: 'Connect with creators you love',
    },
    {
      icon: <Shield size={20} />,
      title: 'Verified Profiles',
      description: 'All creators are ID verified',
    },
    {
  ...
  const checkUsernameAvailability = async username => {
    ...
    setTimeout(() => {
      ...
      const taken = ['johndoe', 'janedoe', 'testuser'].includes(
      ...
      case 1:
        return (
          ...
          >
            ...
            <p className='memberreg-step-subtitle'>
              Join thousands discovering amazing creators
            </p>
              ...
              {formData.password && (
                <div className='memberreg-password-strength'>
                  ...
                  <div className='strength-requirements'>
                    ...
                    <span
                      className={passwordRequirements.hasUpperCase ? 'met' : ''}
                    >
                      <Check size={12} /> Uppercase
                    </span>
                    <span
                      className={passwordRequirements.hasLowerCase ? 'met' : ''}
                    >
                    ...
                    <span
                      className={passwordRequirements.hasSpecial ? 'met' : ''}
                    >
          ...
          >
            ...
            <div className='memberreg-form-group'>
              ...
              <div className='memberreg-radio-group'>
                ...
                <label
                  className='memberreg-radio-option'
      ...
      case 4:
        return (
          ...
          >
            ...
            <p className='memberreg-step-subtitle'>
              Review and agree to get started
            </p>

            {/* Terms and Conditions */}
            <div className='memberreg-agreements'>
              <label
                className='memberreg-checkbox-option large'
                htmlFor='agree-terms'
              >
                <input
                  type='checkbox'
                ...
                <span>
                  I agree to the{' '}
                  <Link to='/terms' className='memberreg-link'>
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to='/privacy' className='memberreg-link'>
                    Privacy Policy
                  </Link>
                </span>
              </label>
