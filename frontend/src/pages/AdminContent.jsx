...
const AdminContent = () => {
  ...
  const getDummyContent = () => {
    ...
    const image1 =
      '/src/assets/jessatsexyselfies_57308_a_beautiful_brunette_girl_in_her_20s__fde0d022-97f5-4153-a96f-e43f6ca953b5_0.png';
    const image2 =
      '/src/assets/jessatsexyselfies_57308_a_beautiful_brunette_girl_in_her_20s__fde0d022-97f5-4153-a96f-e43f6ca953b5_1.png';
    const image3 =
      '/src/assets/jessatsexyselfies_57308_a_beautiful_brunette_girl_in_her_20s__fde0d022-97f5-4153-a96f-e43f6ca953b5_2.png';
  ...
  const handleApprove = async contentId => {
    ...
    try {
      ...
      setContent(prev =>
        prev.map(c => (c._id === contentId ? { ...c, status: 'approved' } : c))
      );
    } catch (error) {
  ...
  return (
    <div className='admin-content-page'>
            ...
            {filteredContent.map(item => (
              <div key={item._id} className='content-item-card'>
                ...
                <div className='content-item-thumbnail'>
                  ...
                  />
                  {item.type === 'video' && (
                    <div className='content-video-duration'>
                      {item.duration}
                    </div>
                  )}
                  <div
                    className={`content-status-badge ${getStatusBadgeClass(item.status)}`}
                  >
                    {item.status}
                  </div>
                </div>
                ...
                <div className='content-item-info'>
                  <div className='content-creator-info'>
                    <span className='content-creator-name'>
              ...
              <tbody>
                {filteredContent.map(item => (
                  <tr key={item._id}>
                    ...
                    <td>
                      <span
                        className={`content-list-status-badge ${getStatusBadgeClass(item.status)}`}
                      >
                        {item.status}
                      </span>
                    </td>
                    ...
                    <td>
                      <span
                        className={
                          item.reports > 0 ? 'content-has-reports' : ''
                        }
                      >
                        {item.reports}
                      </span>
      ...
      {imagePreview && (
        ...
        >
          <div
            className='content-preview-modal-content'
              ...
              {imagePreview.aiFlags && imagePreview.aiFlags.length > 0 && (
                <div className='content-preview-flags'>
                  ...
                  {imagePreview.aiFlags.map((flag, index) => (
                    <span key={index} className='content-flag-item'>
                      {flag}
                    </span>
                  ))}
                </div>
          ...
          <div className='content-details-body'>
            <div className='content-detail-image'>
              ...
              {selectedContent.type === 'video' && (
                <div className='content-detail-video-duration'>
            ...
            <div className='content-detail-info'>
              <div className='content-detail-section'>
                ...
                <p>
                  <strong>Name:</strong> {selectedContent.creator.stageName}
                </p>
                <p>
                  <strong>Email:</strong> {selectedContent.creator.email}
                </p>
                <p>
                  <strong>ID:</strong> {selectedContent.creator._id}
                </p>
              </div>
      ...
      {showRemoveModal && (
        <div
          className='content-removal-overlay'
          onClick={() => setShowRemoveModal(false)}
        >
          <div
            className='content-removal-modal'
            onClick={e => e.stopPropagation()}
          >
            <h2>Remove Content</h2>
            <p>
              Please provide a reason for removing this content. The creator
              will be notified.
            </p>
            ...
            <div className='content-removal-reasons'>
              <button
                ...
                onClick={() =>
                  setRemovalReason('Violates community guidelines')
                }
              >
              ...
              <button
                className='content-reason-btn'
                onClick={() =>
                  setRemovalReason('Explicit content beyond platform standards')
                }
              >
                Too Explicit
              </button>
