...
import { 
  Sparkles, Heart, MessageCircle, Star, 
  TrendingUp, DollarSign, Crown, Zap, X 
} from 'lucide-react';
...
const ConnectionModal = ({ 
  ...
  const handleModalClick = (e) => {
    ...
    if (e.target.closest('.connection-btn') || e.target.closest('.close-button')) {
      return;
    }
  ...
  const getConnectionContent = () => {
    const { creatorName, memberName, profilePhoto, message, spending } = connectionData || {};
      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {connectionType === 'high_value_connection' && userRole === 'creator' && (
            ...
            {connectionType === 'mutual_interest' && (
              <div className="connection-compatibility">
                <div className="compatibility-bar">
                  <div className="compatibility-fill" style={{ width: '85%' }} />
                </div>
