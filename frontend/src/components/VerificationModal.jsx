...
const VerificationModal = ({ verification, isOpen, onClose, onApprove, onReject }) => {
  ...
  return (
    <>
      <div className="VerificationModal-overlay" onClick={handleClose}>
        <div className="VerificationModal-content" onClick={e => e.stopPropagation()}>
          <div className="VerificationModal-header">
            <h2>Verification Details</h2>
            <button className="VerificationModal-closeBtn" onClick={handleClose}>
              ✕
            </button>
          </div>
          ...
          <div className="VerificationModal-body">
            <div className="VerificationModal-section">
              ...
              <div className="VerificationModal-infoGrid">
                ...
                <div className="VerificationModal-infoItem">
                  <label>User ID</label>
                  <p className="VerificationModal-userId">{verification.userId}</p>
                </div>
              </div>
            </div>
                ...
                {verification.documents?.map((doc, index) => (
                  <div key={index} className="VerificationModal-documentItem">
                    ...
                    <div className="VerificationModal-documentInfo">
                      <span className="VerificationModal-documentType">{doc.type}</span>
                      <span className="VerificationModal-documentLabel">Document {index + 1}</span>
                    </div>
                  </div>
                ))}
              </div>
      ...
      {selectedDocument && (
        <div className="VerificationModal-documentViewer" onClick={closeDocumentViewer}>
          <div className="VerificationModal-documentViewerContent" onClick={e => e.stopPropagation()}>
            <button 
