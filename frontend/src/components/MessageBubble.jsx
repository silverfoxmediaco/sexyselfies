...
const MessageBubble = ({
  ...
  const renderContent = () => {
    ...
    if (message.type === 'video') {
      if (isLocked) {
        return (
          <div className='locked-content'>
            <video poster={message.thumbnail} className='blur-overlay'>
      ...
      return (
        <div className='message-media'>
          <video controls poster={message.thumbnail} preload='metadata'>
  ...
  if (message.type === 'typing') {
    return (
      <div
        className={`message-bubble-wrapper typing ${isCreator ? 'creator' : ''}`}
      >
