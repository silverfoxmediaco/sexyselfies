            ...
            <div className={`swipe-card ${swipeDirection}`}>
              ...
              <div className='swipe-actions'>
                ...
                <button
                  ...
                  onClick={() => handleSwipe('swipe-super')}
                >
