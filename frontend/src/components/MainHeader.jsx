...
import { 
  ...
  Camera, DollarSign, TrendingUp, Shield,
  Sparkles, Settings, LogOut, CreditCard,
  ...
  const getNavItems = () => {
    if (!isLoggedIn) {
      ...
      return [
        ...
        { icon: Sparkles, label: 'Become Creator', path: '/creator/register', highlight: true }
      ];
    }
    ...
    if (userRole === 'creator') {
      return [
        ...
        { icon: UserSearch, label: 'Target Members', path: '/creator/browse-members' }, // BrowseMembers.jsx - browse/target members
                  ...
                  <div className="user-menu-wrapper">
                    ...
                    {showUserMenu && (
                      <div className="mainheader-dropdown">
                        ...
                        {userRole === 'member' && (
                          <>
                            <Link to="/member/purchased" className="dropdown-item">
                              <Grid3x3 size={18} />
                        ...
                        {userRole === 'creator' && (
                          <>
                            <Link to="/creator/profile-setup" className="dropdown-item">
                              <Settings size={18} />
                              <span>Profile Settings</span>
                            </Link>
                            <Link to="/creator/content" className="dropdown-item">
                              <Grid3x3 size={18} />
                              <span>Manage Content</span>
                            </Link>
                            <Link to="/creator/members" className="dropdown-item">
                              <Users size={18} />
        ...
        <div className="mainheader-mobile-menu mobile-only">
          <div className="mobile-menu-content">
            ...
            {isLoggedIn && (
              <>
                ...
                <nav className="mobile-nav-links">
                  ...
                  <Link to={`/${userRole}/settings`} className="mobile-nav-link">
                    <Settings size={20} />
                    <span>Settings</span>
                  </Link>
                </nav>
            ...
            <div className="mobile-menu-actions">
              {!isLoggedIn ? (
                <>
                  <Link to="/member/login" className="mobile-action-btn secondary">
                    <LogIn size={18} />
                    <span>Member Login</span>
                  </Link>
                  <Link to="/member/register" className="mobile-action-btn primary">
                    <UserPlus size={18} />
                    <span>Join Free</span>
                  </Link>
                  <div className="mobile-menu-divider" />
                  <Link to="/creator/login" className="mobile-action-btn outline">
                    <Sparkles size={18} />
