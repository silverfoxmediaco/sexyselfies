...
const SimpleConnectionsList = ({ connections = [], loading = false, error = null }) => {
  const navigate = useNavigate();

  // Retry function for error state (if needed)
  const handleRetry = () => {
    // This would trigger a refetch from the parent component
  ...
  const handleDeleteConnection = async (connectionId, connectionName) => {
    ...
    try {
      ...
      // Show success message and reload to refresh data
  ...
  // No longer needed - data comes from props
