...
transactionSchema.pre('save', function(next) {
  if (this.isModified('amount') || this.isNew) {
    ...
    this.creatorEarnings = this.amount * 0.80;
...
transactionSchema.statics.getDailyRevenue = async function(creatorId, date = new Date()) {
...
transactionSchema.statics.isContentUnlocked = async function(memberId, contentId) {
...
transactionSchema.statics.getMemberUnlocks = async function(memberId, creatorId) {
